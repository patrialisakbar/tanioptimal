...
class RiceVarietySawSeeder extends Seeder
{
     ...
     * 
     * Kriteria:
     * C1: Jenis Tanah (bobot 4) - Ultisol:3, Liat:2, Aluvial:1
     * C2: Curah Hujan (bobot 2) - 800-1200:3, 1200-1500:2, 1500-1800:1
     * C3: Suhu Optimal (bobot 3) - 30-35°C:3, 27-29°C:2, 25-26°C:1
     * C4: Ketinggian Lahan (bobot 1) - 0-500:3, 500-800:2, 800-1200:1
     * C5: Ketersediaan Air (bobot 5) - Tadah Hujan:3, Irigasi Sederhana:2, Rawa:1
     */
    public function run(): void
    {
        // Mapping hanya untuk 5 varietas dengan scores berdasarkan tabel
        $varietiesScores = [
